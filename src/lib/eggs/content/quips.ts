...
export const QUIPS: readonly string[] = [
  ...
  'One down. The pile noticed.',
  'That one had been sitting there with its coat on, waiting.',
  'Resolved, in the least dramatic way possible.',
  'The dice approve of this development.',
  'Somewhere, a future version of you just got a slightly easier day.',
  'Task neutralised. No survivors.',
  'That is one fewer thing occupying rent-free space in your head.',
  'You and the list are currently winning. Do not tell the list.',
  'Struck through. Gone. Historical.',
  'The backlog flinched.',
  'That is the sound of something being genuinely over.',
  'Done is such an underrated tense.',
  'One less open tab in the mind.',
  'Congratulations, you have created a small amount of order.',
  'The universe trends toward disorder. You, briefly, did not.',
  'Another one converted from "should" to "did".',
  'Chaos: organized. Slightly. Locally.',
  'That task will not be bothering you again.',
  'Progress is unglamorous and you just did some.',
  'The version of you who added this task says thank you.',
  'Ticked. The satisfying kind.',
  'One task closer to whatever comes after the list.',
  'You just spent finite life on a finite task and finished it. Correctly.',
  'The list is shorter and you are the reason.',
  'That one is now somebody else\'s problem, namely nobody\'s.',
  'Small win logged. They add up faster than they feel like they do.',
  'Handled with a minimum of ceremony. The best way.',
  'That is the good kind of gone.',
  'Task complete. The pile is re-evaluating its strategy.',
  'You did the thing instead of thinking about the thing. Rare.',
  'One more brick out of the wall.',
  'The doing was probably shorter than the dreading. It usually is.',
  'Consider it unhappened. In the good direction.',
  'Another entry for the "actually finished" column.',
  'That is momentum. Try not to look directly at it.',
  'The task is done and cannot be un-done, which is the whole appeal.',
  'One fewer thing between you and an evening.',
